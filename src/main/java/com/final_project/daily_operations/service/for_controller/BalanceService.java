...
public class BalanceService {
    ...
    public List<Balance> getBalances(String username) throws UsernameDoesNotExistException {
    ...
    public List<Balance> addNewBalance(String username, Long currencyId) throws DuplicateCurrencyAccountException, ToMuchBalanceAccountException, UsernameDoesNotExistException {
