...
public class TransactionServiceValidation {
    ...
    public static final String USER_DO_NOT_HAVE_ACCESS_MAKE_PAYMENT = "User with id %s do not have access make payment from account number: %s";
    ...
    public void isPaymentValid(Transaction transaction, Customer customer) throws NoAccessException, WrongCurrencyException, NoEnoughMoneyException {
